...
namespace Grids2D {
	...
	public partial class Grid2D : MonoBehaviour {
		...
		public void CellSetSideCrossCost (int cellIndex, CELL_SIDE side, int cost, CELL_DIRECTION direction = CELL_DIRECTION.Both) {
			if (cellIndex < 0 || cellIndex >= cells.Count)
				return;
		...
		public void CellSetAllSidesCrossCost (int cellIndex, int cost) {
		...
		/// <param name="cellIndex">Cell index.</param>
		/// <param name="cost">Crossing cost.</param>
		public void CellSetCrossCost (int cellIndex, int cost, CELL_DIRECTION direction = CELL_DIRECTION.Entering) {
			if (cellIndex < 0 || cellIndex >= cells.Count)
				return;
		...
		/// <param name="cellIndex">Cell index.</param>
		/// <param name="cost">Crossing cost.</param>
		public int CellGetCrossCost (int cellIndex, CELL_DIRECTION direction = CELL_DIRECTION.Entering) {
			if (cellIndex < 0 || cellIndex >= cells.Count)
				return 0;
		...
		public void CellSetCrossCost(int cellStartIndex, int cellEndIndex, int cost) {
		...
		/// <param name="cellStartIndex">Cell start index.</param>
		/// <param name="cellEndIndex">Cell end index.</param>
		public int CellGetCrossCost(int cellStartIndex, int cellEndIndex) {
			if (cellStartIndex < 0 || cellStartIndex >= cells.Count || cellEndIndex < 0 || cellEndIndex >= cells.Count)
				return 0;
			CELL_SIDE side = GetSideByVector (cells [cellStartIndex].center - cells [cellEndIndex].center);
		...
		public int CellGetSideCrossCost (int cellIndex, CELL_SIDE side, CELL_DIRECTION direction = CELL_DIRECTION.Entering) {
			if (cellIndex < 0 || cellIndex >= cells.Count)
				return 0;
			Cell cell = cells [cellIndex];
			if (direction == CELL_DIRECTION.Exiting) {
